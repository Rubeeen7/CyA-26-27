...
// Fecha: 08/09/2026
// Archivo Cliente_single_grades.cc: programa cliente.
// Contiene la función main del ejercicio de calificación única por estudiante.
// Referencias:
...
int main(int argc, char* argv[]) {
  UsageSingle(argc, argv);

  const std::string input_file{argv[1]};
  CalificacionesUnicas calificaciones;
